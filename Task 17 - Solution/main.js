...
var guests = ["Saima", "Muskan", "Fatima", "Moeez", "Mehak", "Zeeshan"];
...
while (guests.length > 2) {
    ...
    console.log("sorry, ".concat(removeGuest, ", you are no longerinvited to dinner."));
}
;
// (c) : print message to two guests who are still invited for dinner
guests.forEach(function (guest) { console.log("Dear ".concat(guest, ", you are still invited to the dinner.")); });
